...
project-mind-mcp interacts deeply with your filesystem. It reads source files across your entire codebase, writes to agent configuration files, and spawns background processes. This is inherent to what it does — not a bug.
...
metadata from
`https://api.github.com/repos/usman8786/project-mind-mcp/releases/latest`.
...
Explicit install, package-manager, and `project-mind-mcp update` flows are
...
1. **Do NOT open a public issue, PR, or social-media post** for security
   vulnerabilities.
2. **Preferred:** use GitHub's [private vulnerability reporting](https://github.com/usman8786/project-mind-mcp/security/advisories/new)
...
[GitHub Security Advisory](https://github.com/usman8786/project-mind-mcp/security/advisories)
...
- **Shell injection prevention** — `pmm_validate_shell_arg()` rejects metacharacters before all `popen()`/`system()` calls
...
gh attestation verify <downloaded-file> \
  ...
  --signer-workflow usman8786/project-mind-mcp/.github/workflows/_build.yml
