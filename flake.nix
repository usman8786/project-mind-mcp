{
  description = "project-mind-mcp — C11 MCP server for codebase indexing";
    ...
    in
    {
      packages = forAllSystems (pkgs: {
        default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            make -j$NIX_BUILD_CORES -f Makefile.pmm pmm
          '';

          installPhase = ''
            install -Dm755 build/c/project-mind-mcp $out/bin/project-mind-mcp
          '';
