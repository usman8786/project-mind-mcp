...
export const messages = {
  en: {
    ...
    projects: {
      ...
      noIndexedProjects: "No indexed projects yet",
      emptyHint: "Point Project Mind at a repository root to build its knowledge graph.",
      indexFirstRepository: "Index a repository",
    ...
    index: {
      ...
      jumpHome: "Home",
      jumpWindows: "Windows C:",
      wslHint: "On WSL, Windows drives live under /mnt/c — use the shortcut or scroll to mnt.",
    },
    adr: {
    ...
    docs: {
      ...
      pathPlaceholder: "/absolute/path/to/spec.md or /folder",
      hint: "Browse or attach md/txt/rst/yaml/json/docx/pdf — then Re-index. Docs become Document/DocSection nodes (not Folders).",
      browse: "Browse files & folders",
      hideBrowse: "Hide browser",
      attachFolder: "Attach this folder",
      browseEmpty: "No subfolders or doc files here",
  ...
  zh: {
    ...
    projects: {
      ...
      emptyHint: "选择仓库根目录，构建知识图谱。",
      indexFirstRepository: "索引仓库",
      viewGraph: "查看图谱",
      nodes: "节点",
      edges: "边",
      nodesLabel: "节点",
    ...
    index: {
      ...
      jumpHome: "主目录",
      jumpWindows: "Windows C:",
      wslHint: "在 WSL 中，Windows 磁盘位于 /mnt/c — 使用快捷方式或滚动到 mnt。",
    },
    adr: {
      title: "架构决策记录",
      lastUpdated: "最后更新",
    ...
    docs: {
      ...
      add: "附加路径",
      empty: "尚无附加文档",
      pathPlaceholder: "/absolute/path/to/spec.md 或 /folder",
      hint: "浏览或附加 md/txt/rst/yaml/json/docx/pdf — 然后重新索引。文档会成为 Document/DocSection 节点（不是 Folders）。",
      browse: "浏览文件和文件夹",
      hideBrowse: "隐藏浏览器",
      attachFolder: "附加此文件夹",
      browseEmpty: "此处无子文件夹或文档文件",
      reindex: "立即重新索引",
    },
    control: {
      panel: "控制面板",
