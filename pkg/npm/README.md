...
[![npm](https://img.shields.io/npm/v/project-mind-mcp?style=flat&color=blue)](https://www.npmjs.com/package/project-mind-mcp)
...
[![License](https://img.shields.io/badge/license-MIT-green)](https://github.com/usman8786/project-mind-mcp/blob/main/LICENSE)
...
```bash
project-mind-mcp install          # configure all detected coding agents
project-mind-mcp --version
project-mind-mcp --help
project-mind-mcp update           # update to latest release
project-mind-mcp uninstall        # remove agent configs
```
...
```bash
project-mind-mcp cli index_repository '{"repo_path": "/path/to/repo"}'
project-mind-mcp cli search_graph '{"name_pattern": ".*Handler.*", "label": "Function"}'
project-mind-mcp cli trace_call_path '{"function_name": "main", "direction": "both"}'
project-mind-mcp cli get_architecture '{}'
```
...
See [github.com/usman8786/project-mind-mcp](https://github.com/usman8786/project-mind-mcp) for the full README including all MCP tools, configuration options, graph data model, and language support details.
