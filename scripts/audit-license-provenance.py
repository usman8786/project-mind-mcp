...
GRAMMARS = os.path.join(ROOT, "internal/pmm/vendored/grammars")
...
LIBS = {
    ...
    "internal/pmm/vendored/lz4": ("lz4/lz4", "lib/LICENSE"),
    "internal/pmm/vendored/zstd": ("facebook/zstd", None),
    "internal/pmm/vendored/simplecpp": ("danmar/simplecpp", None),
    "internal/pmm/vendored/verstable": ("JacksonAllan/Verstable", None),
    "internal/pmm/vendored/wyhash": ("wangyi-fudan/wyhash", None),
    "internal/pmm/vendored/ts_runtime": ("tree-sitter/tree-sitter", None),
    "internal/pmm/vendored/common": ("tree-sitter/tree-sitter-html", None),
    "internal/pmm/vendored/common/tree_sitter": ("tree-sitter/tree-sitter", None),
}
