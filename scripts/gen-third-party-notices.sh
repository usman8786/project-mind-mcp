...

{
    ...
    echo
    echo "This file accompanies the project-mind-mcp binary distribution."
    ...
    echo "---"
    echo
    cat "$ROOT/internal/pmm/vendored/grammars/MANIFEST.md"

    find "$ROOT/vendored" "$ROOT/internal/pmm/vendored" -type f \
