...
"""
gen-py-stdlib.py — Generate pmm_python_stdlib_register from typeshed stubs.
...
source file (internal/pmm/lsp/generated/python_stdlib_data.c) that
...
internal/pmm/lsp/generated/python_stdlib_data.c when run without args.
"""
...
#define PMM_PYTHON_STDLIB_GENERATED 1
...
def emit(stubs: list[ModuleStubs], output_path: Path) -> None:
    ...
    for ms in stubs:
        ...
        for cls in ms.classes:
            ...
            out_lines.append("    pmm_registry_add_type(reg, rt);\n")
            ...
            for m in cls.methods:
                ...
                out_lines.append("    pmm_registry_add_func(reg, rf);\n")
...
def main() -> int:
    ...
    parser.add_argument(
        "output",
        nargs="?",
        default="internal/pmm/lsp/generated/python_stdlib_data.c",
    )
