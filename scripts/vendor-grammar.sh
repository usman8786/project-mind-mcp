#!/usr/bin/env bash
# vendor-grammar.sh: Vendor a single tree-sitter grammar into internal/pmm/vendored/grammars/<name>/
...
GRAMMAR_DIR="$PROJECT_DIR/internal/pmm/vendored/grammars/$NAME"
TMPDIR="$(mktemp -d)"
