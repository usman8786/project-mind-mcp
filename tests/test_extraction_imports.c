 ...
 * We test the EXTRACTION layer only: does pmm_extract_file() populate
 ...
 * PHP        UNCERTAIN             PMM_LANG_PHP → parse_generic_imports("expression_
 ...
 * C#         UNCERTAIN             PMM_LANG_CSHARP → parse_generic_imports("using_directive")
...
static CBMFileResult *do_extract(const char *src, CBMLanguage lang,
                                  const char *path) {
    return pmm_extract_file(src, (int)strlen(src), lang, "testproj", path,
                             0, NULL, NULL);
}
...
static int run_import_case(const import_case_t *tc) {
    ...
    if (!r) {
        printf("  FAIL [%s]: pmm_extract_file returned NULL\n", tc->label);
        return 1;
    }
    if (r->has_error) {
...
static const import_case_t csharp_cases[] = {
    ...
    /* Newtonsoft.Json */
    { PMM_LANG_CSHARP, "I.cs",
      "using Newtonsoft.Json;\nusing Newtonsoft.Json.Linq;\npublic class I {}\n",
      {"Newtonsoft.Json", NULL}, 2, "cs_json" },

    /* multiple aliases */
    { PMM_LANG_CSHARP, "J.cs",
...
static const zero_import_case_t zero_cases[] = {
    { PMM_LANG_RUST,       "a.rs",   "fn main() { println!(\"hello\"); }\n",
      "rust_no_imports" },
    { PMM_LANG_JAVA,       "A.java", "public class A { public static void main(String[] a) {} }\n",
      "java_no_imports" },
    { PMM_LANG_KOTLIN,     "A.kt",   "fun main() { println(\"hello\") }\n",
      "kotlin_no_imports" },
    { PMM_LANG_CSHARP,     "A.cs",   "public class A { static void Main() {} }\n",
      "cs_no_imports" },
    { PMM_LANG_PHP,        "a.php",  "<?php\necho 'hello';\n",
      "php_no_imports" },
    { PMM_LANG_GO,         "a.go",   "package main\nfunc main() {}\n",
      "go_no_imports" },
    { PMM_LANG_PYTHON,     "a.py",   "def main(): pass\n",
      "py_no_imports" },
    { PMM_LANG_TYPESCRIPT, "a.ts",   "function hello(): void { console.log('hi'); }\n",
      "ts_no_imports" },
    { PMM_LANG_JAVASCRIPT, "a.js",   "function hello() { return 42; }\n",
      "js_no_imports" },
};
