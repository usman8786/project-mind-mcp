...
DEPENDENCIES=(
    internal/pmm/vendored/ts_runtime/src/stack.c
    internal/pmm/vendored/ts_runtime/src/stack.h
    internal/pmm/vendored/ts_runtime/src/unicode/utf8.h
    internal/pmm/vendored/ts_runtime/include/tree_sitter/api.h
)
TARGETS=(
...
for dependency in "${DEPENDENCIES[@]}"; do
    ...
    for target in "${TARGETS[@]}"; do
        ...
        status=0
        make -f Makefile.pmm -q -W "$dependency" \
