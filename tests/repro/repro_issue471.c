 ...
 *   (internal/pmm/vendored/ts_runtime/src/stack.c, function starting at line 200)
 ...
 *
 *   The `PMM_TS_STACK_MERGE_MAX_DEPTH` cap added in #461 bounds call-stack
 ...
 *   internal/pmm/vendored/ts_runtime/src/stack.c, `stack_node_add_link`:
...
TEST(repro_issue471_glr_nested_ambiguity_terminates) {
    ...
    if (pid == 0) {
         ...
         *
         * We do NOT call pmm_init() here: pmm_extract_file() is
