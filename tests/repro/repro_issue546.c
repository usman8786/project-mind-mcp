 ...
 *   first one returned by pmm_store_find_nodes_by_name) and BFS-traverses only
 ...
 *   Either in pmm_store_find_nodes_by_name / pmm_store_bfs (union traversal
...
TEST(repro_issue546_dts_split_caller_set) {
     ...
     *   pmm_store_find_nodes_by_name).  Only callers whose CALLS edges
