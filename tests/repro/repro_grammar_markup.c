 ...
 *
 * Languages covered (18) and the PMM_LANG_* enum each uses. All enums verified
 * present in internal/pmm/pmm.h (line numbers as of HEAD): MARKDOWN(62),
 ...
 * None missing; none skipped. (Note: the enum is PMM_LANG_JINJA2, not
 * PMM_LANG_JINJA.)
 *
 *   MARKDOWN   -> PMM_LANG_MARKDOWN
 *   RST        -> PMM_LANG_RST
 *   TYPST      -> PMM_LANG_TYPST
 *   BIBTEX     -> PMM_LANG_BIBTEX
 *   MERMAID    -> PMM_LANG_MERMAID
 *   PO         -> PMM_LANG_PO
 *   DIFF       -> PMM_LANG_DIFF
 *   REGEX      -> PMM_LANG_REGEX
 ...
 *   BLADE      -> PMM_LANG_BLADE
 *   PURESCRIPT -> PMM_LANG_PURESCRIPT
 *   SOQL       -> PMM_LANG_SOQL
 *   SOSL       -> PMM_LANG_SOSL
 *
 * BATTERY DIMENSIONS
 ...
 *      through pmm_extract_file must RETURN non-NULL (has_error may be set). A
...
TEST(repro_grammar_markup_markdown) {
     ...
     * the graph to "Class". */
    if (markup_struct_battery("Markdown", src, PMM_LANG_MARKDOWN, "README.md",
                              "Section", NULL) != 0)
        return 1;
    return markup_robustness("Markdown", bad, PMM_LANG_MARKDOWN, "README.md");
}
...
TEST(repro_grammar_markup_rst) {
    ...
    if (markup_base_battery("RST", src, PMM_LANG_RST, "index.rst") != 0)
        return 1;
    return markup_robustness("RST", bad, PMM_LANG_RST, "index.rst");
}
...
TEST(repro_grammar_markup_typst) {
    ...
    if (markup_callable_battery("Typst", src, PMM_LANG_TYPST, "doc.typ",
                                "Function", "greet") != 0)
        return 1;
    if (markup_robustness("Typst", bad, PMM_LANG_TYPST, "doc.typ") != 0)
        return 1;
...
TEST(repro_grammar_markup_bibtex) {
    ...
    if (markup_base_battery("BibTeX", src, PMM_LANG_BIBTEX, "refs.bib") != 0)
        return 1;
    return markup_robustness("BibTeX", bad, PMM_LANG_BIBTEX, "refs.bib");
}
...
TEST(repro_grammar_markup_mermaid) {
    ...
    if (markup_base_battery("Mermaid", src, PMM_LANG_MERMAID, "diagram.mmd") != 0)
        return 1;
    return markup_robustness("Mermaid", bad, PMM_LANG_MERMAID, "diagram.mmd");
}
...
TEST(repro_grammar_markup_po) {
    ...
    if (markup_base_battery("PO", src, PMM_LANG_PO, "de.po") != 0)
        return 1;
    return markup_robustness("PO", bad, PMM_LANG_PO, "de.po");
}
...
TEST(repro_grammar_markup_diff) {
    ...
    if (markup_base_battery("Diff", src, PMM_LANG_DIFF, "change.diff") != 0)
        return 1;
    return markup_robustness("Diff", bad, PMM_LANG_DIFF, "change.diff");
}
...
TEST(repro_grammar_markup_regex) {
    ...
    if (markup_base_battery("Regex", src, PMM_LANG_REGEX, "date.re") != 0)
        return 1;
    return markup_robustness("Regex", bad, PMM_LANG_REGEX, "date.re");
}
...
TEST(repro_grammar_markup_capnp) {
    ...
    if (markup_struct_battery("CapnP", src, PMM_LANG_CAPNP, "user.capnp",
                              "Class", "Function") != 0)
        return 1;
    return markup_robustness("CapnP", bad, PMM_LANG_CAPNP, "user.capnp");
}
...
TEST(repro_grammar_markup_smithy) {
    ...
    if (markup_struct_battery("Smithy", src, PMM_LANG_SMITHY, "model.smithy",
                              "Class", "Function") != 0)
        return 1;
    return markup_robustness("Smithy", bad, PMM_LANG_SMITHY, "model.smithy");
}
...
TEST(repro_grammar_markup_wit) {
    ...
    if (markup_struct_battery("WIT", src, PMM_LANG_WIT, "users.wit",
                              "Class", "Function") != 0)
        return 1;
    return markup_robustness("WIT", bad, PMM_LANG_WIT, "users.wit");
}
...
TEST(repro_grammar_markup_qml) {
    ...
    if (markup_callable_battery("QML", src, PMM_LANG_QML, "Widget.qml",
                                "Function", "max") != 0)
        return 1;
    if (markup_robustness("QML", bad, PMM_LANG_QML, "Widget.qml") != 0)
        return 1;
...
TEST(repro_grammar_markup_liquid) {
    ...
    if (markup_base_battery("Liquid", src, PMM_LANG_LIQUID, "page.liquid") != 0)
        return 1;
    return markup_robustness("Liquid", bad, PMM_LANG_LIQUID, "page.liquid");
}
 ...
 * (Enum is PMM_LANG_JINJA2, verified at pmm.h:114.)
 */
TEST(repro_grammar_markup_jinja2) {
    ...
    if (markup_base_battery("Jinja2", src, PMM_LANG_JINJA2, "page.j2") != 0)
        return 1;
    return markup_robustness("Jinja2", bad, PMM_LANG_JINJA2, "page.j2");
}
...
TEST(repro_grammar_markup_blade) {
    ...
    if (markup_base_battery("Blade", src, PMM_LANG_BLADE, "page.blade.php") != 0)
        return 1;
    return markup_robustness("Blade", bad, PMM_LANG_BLADE, "page.blade.php");
}
...
TEST(repro_grammar_markup_purescript) {
    ...
    if (markup_callable_battery("PureScript", src, PMM_LANG_PURESCRIPT, "Main.purs",
                                "Function", "greet") != 0)
        return 1;
    if (markup_robustness("PureScript", bad, PMM_LANG_PURESCRIPT, "Main.purs") != 0)
        return 1;
...
TEST(repro_grammar_markup_soql) {
    ...
    if (markup_base_battery("SOQL", src, PMM_LANG_SOQL, "query.soql") != 0)
        return 1;
    return markup_robustness("SOQL", bad, PMM_LANG_SOQL, "query.soql");
}
...
TEST(repro_grammar_markup_sosl) {
    ...
    if (markup_base_battery("SOSL", src, PMM_LANG_SOSL, "search.sosl") != 0)
        return 1;
    return markup_robustness("SOSL", bad, PMM_LANG_SOSL, "search.sosl");
}
