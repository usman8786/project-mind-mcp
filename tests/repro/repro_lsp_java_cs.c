 ...
 * (internal/pmm/lsp/java_lsp.c) and C# (internal/pmm/lsp/cs_lsp.c) hybrid LSPs.
 *
 ...
 *   resolver can still be ABSENT here if pmm_pipeline_find_lsp_resolution
 ...
 *   grepped from source (grep '"lsp_' internal/pmm/lsp/java_lsp.c):
 ...
 *   from source (grep '"cs_' internal/pmm/lsp/cs_lsp.c):
