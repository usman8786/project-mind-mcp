 ...
 * hybrid LSP (internal/pmm/lsp/c_lsp.c).
 *
 ...
 *   these can silently fail: pmm_pipeline_find_lsp_resolution
 ...
 *   the source (grep '"lsp_' internal/pmm/lsp/c_lsp.c), with its keying site:
