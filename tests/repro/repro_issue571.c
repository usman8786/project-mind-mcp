 ...
 *   https://github.com/usman8786/project-mind-mcp/issues/571
 *
 * ROOT CAUSE (src/pipeline/fqn.c, pmm_project_name_from_path, lines ~341-348):
 *
...
TEST(repro_issue571_cjk_project_name) {
    ...
    char *name = pmm_project_name_from_path(cjk_path);
