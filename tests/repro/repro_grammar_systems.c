 ...
 *
 * Languages covered (12) and the PMM_LANG_* enum each uses (every enum verified
 * present in internal/pmm/pmm.h; none missing, none skipped):
 *   Zig      -> PMM_LANG_ZIG
 *   Nim      -> PMM_LANG_NIM
 *   Crystal  -> PMM_LANG_CRYSTAL
 *   Hare     -> PMM_LANG_HARE
 *   Odin     -> PMM_LANG_ODIN
 *   Pony     -> PMM_LANG_PONY
 *   Ada      -> PMM_LANG_ADA
 ...
 *   Pascal   -> PMM_LANG_PASCAL
 *   Solidity -> PMM_LANG_SOLIDITY
 *   Move     -> PMM_LANG_MOVE
 *
 * BATTERY DIMENSIONS
 * ------------------
 ...
 * compiled/OOP family: pmm_find_enclosing_func (helpers.c) walks the TSNode
 ...
 * "function_declaration", so pmm_find_enclosing_func resolves the caller and the
...
TEST(repro_grammar_systems_zig) {
    static const char src[] =
        ...
        "    return add(x, 1);\n"
        "}\n";
    if (single_file_battery("Zig", src, PMM_LANG_ZIG, "calc.zig",
 ...
 * (pmm_extract_file returns a result), but dims 5/6 RED (zero defs, zero calls)
...
TEST(repro_grammar_systems_nim) {
     ...
     * grammar/parser defect, not a pmm extraction bug. Original assertions below
    ...
    static const char src[] =
        ...
        "  return add(x, 1)\n";
    if (single_file_battery("Nim", src, PMM_LANG_NIM, "calc.nim",
                            "Function", NULL, "add") != 0)
        return 1;
 ...
 * func_kinds_generic, so pmm_find_enclosing_func cannot reach the method and
...
TEST(repro_grammar_systems_crystal) {
    static const char src[] =
        ...
        "  end\n"
        "end\n";
    if (single_file_battery("Crystal", src, PMM_LANG_CRYSTAL, "calc.cr",
                            "Method", "Class", "add") != 0)
        return 1;
...
TEST(repro_grammar_systems_hare) {
    static const char src[] =
        ...
        "\treturn add(x, 1);\n"
        "};\n";
    if (single_file_battery("Hare", src, PMM_LANG_HARE, "calc.ha",
                            "Function", NULL, "add") != 0)
        return 1;
 ...
 * not in func_kinds_generic, so pmm_find_enclosing_func falls back to Module.
 */
TEST(repro_grammar_systems_odin) {
    static const char src[] =
        ...
        "\treturn add(x, 1)\n"
        "}\n";
    if (single_file_battery("Odin", src, PMM_LANG_ODIN, "calc.odin",
                            "Function", "Class", "add") != 0)
        return 1;
...
TEST(repro_grammar_systems_pony) {
    static const char src[] =
        ...
        "    add(x, 1)\n";
    if (single_file_battery("Pony", src, PMM_LANG_PONY, "calc.pony",
                            "Method", "Class", "add") != 0)
        return 1;
...
TEST(repro_grammar_systems_ada) {
    static const char src[] =
        ...
        "\n"
        "end Calc;\n";
    if (single_file_battery("Ada", src, PMM_LANG_ADA, "calc.adb",
                            "Function", NULL, "Add") != 0)
        return 1;
...
TEST(repro_grammar_systems_fortran) {
    static const char src[] =
        ...
        "end module calc\n";
    if (single_file_battery("Fortran", src, PMM_LANG_FORTRAN, "calc.f90",
                            "Function", NULL, "add") != 0)
        return 1;
...
TEST(repro_grammar_systems_cobol) {
    static const char src[] =
        ...
        "           EXIT PROGRAM.\n"
        "       END PROGRAM SUB.\n";
    if (single_file_battery("COBOL", src, PMM_LANG_COBOL, "calc.cob",
                            "Function", NULL, "SUB") != 0)
        return 1;
...
TEST(repro_grammar_systems_pascal) {
    static const char src[] =
        ...
        "begin\n"
        "end.\n";
    if (single_file_battery("Pascal", src, PMM_LANG_PASCAL, "calc.pas",
                            "Function", NULL, "Add") != 0)
        return 1;
 ...
 * so pmm_find_enclosing_func resolves the enclosing function and attributes the
...
TEST(repro_grammar_systems_solidity) {
    static const char src[] =
        ...
        "    }\n"
        "}\n";
    if (single_file_battery("Solidity", src, PMM_LANG_SOLIDITY, "Calc.sol",
                            "Method", "Class", "add") != 0)
        return 1;
...
TEST(repro_grammar_systems_move) {
    static const char src[] =
        ...
        "    }\n"
        "}\n";
    if (single_file_battery("Move", src, PMM_LANG_MOVE, "calc.move",
                            "Function", NULL, "add") != 0)
        return 1;
