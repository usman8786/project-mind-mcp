 ...
 *
 * Languages covered (12) and the PMM_LANG_* enum each uses:
 *   C       -> PMM_LANG_C
 *   C++     -> PMM_LANG_CPP
 *   CUDA    -> PMM_LANG_CUDA
 *   Rust    -> PMM_LANG_RUST
 ...
 * the dominant failure is pmm_enclosing_func_qn falling back to the module QN when
 * pmm_find_enclosing_func cannot walk the TSNode ancestry to a function node
...
TEST(repro_grammar_core_c) {
    static const char src[] =
        ...
        "    return add(x, 1);\n"
        "}\n";
    if (single_file_battery("C", src, PMM_LANG_C, "main.c",
                            "Function", NULL, "add") != 0)
        return 1;
...
TEST(repro_grammar_core_cpp) {
    static const char src[] =
        ...
        "    }\n"
        "};\n";
    if (single_file_battery("C++", src, PMM_LANG_CPP, "main.cpp",
...
TEST(repro_grammar_core_cuda) {
    static const char src[] =
        ...
        "    out[0] = helper(21);\n"
        "}\n";
    if (single_file_battery("CUDA", src, PMM_LANG_CUDA, "k.cu",
 ...
 * Expected: dims 1-6 + 8 GREEN, dim 7 RED (pmm_pxc_has_cross_lsp is false for
 * PMM_LANG_RUST, so the cross-LSP rescue never runs; tree-sitter enclosing-func
...
TEST(repro_grammar_core_rust) {
    static const char src[] =
        ...
        "    }\n"
        "}\n";
    if (single_file_battery("Rust", src, PMM_LANG_RUST, "lib.rs",
...
TEST(repro_grammar_core_go) {
    static const char src[] =
        ...
        "    return add(c.base, x)\n"
        "}\n";
    if (single_file_battery("Go", src, PMM_LANG_GO, "main.go",
                            "Function", "Struct", "add") != 0)
        return 1;
...
TEST(repro_grammar_core_java) {
    static const char src[] =
        ...
        "    }\n"
        "}\n";
    if (single_file_battery("Java", src, PMM_LANG_JAVA, "Calculator.java",
                            "Method", "Class", "add") != 0)
        return 1;
...
TEST(repro_grammar_core_csharp) {
    static const char src[] =
        ...
        "    }\n"
        "}\n";
    if (single_file_battery("C#", src, PMM_LANG_CSHARP, "Calculator.cs",
                            "Method", "Class", "Add") != 0)
        return 1;
...
TEST(repro_grammar_core_kotlin) {
    static const char src[] =
        ...
        "    }\n"
        "}\n";
    if (single_file_battery("Kotlin", src, PMM_LANG_KOTLIN, "Calc.kt",
                            "Method", "Class", "add") != 0)
        return 1;
...
TEST(repro_grammar_core_scala) {
    static const char src[] =
        ...
        "  }\n"
        "}\n";
    if (single_file_battery("Scala", src, PMM_LANG_SCALA, "Calc.scala",
                            "Method", "Class", "add") != 0)
        return 1;
...
TEST(repro_grammar_core_swift) {
    static const char src[] =
        ...
        "    }\n"
        "}\n";
    if (single_file_battery("Swift", src, PMM_LANG_SWIFT, "Calc.swift",
                            "Method", "Struct", "add") != 0)
        return 1;
...
TEST(repro_grammar_core_objc) {
    static const char src[] =
        ...
        "}\n"
        "@end\n";
    if (single_file_battery("Obj-C", src, PMM_LANG_OBJC, "Calc.m",
 ...
 * breadth callable-sourcing table). Uses PMM_LANG_DLANG.
 */
TEST(repro_grammar_core_dlang) {
    static const char src[] =
        ...
        "    }\n"
        "}\n";
    if (single_file_battery("D", src, PMM_LANG_DLANG, "calc.d",
                            "Function", "Struct", "add") != 0)
        return 1;
