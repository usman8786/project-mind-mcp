...
TEST(repro_grammar_scripting_python) {
    static const char src[] =
        ...
        "    def compute(self, x):\n"
        "        return add(x, 1)\n";
    if (single_file_battery("Python", src, PMM_LANG_PYTHON, "calc.py",
...
TEST(repro_grammar_scripting_ruby) {
    static const char src[] =
        ...
        "  end\n"
        "end\n";
    if (single_file_battery("Ruby", src, PMM_LANG_RUBY, "calc.rb",
                            "Method", "Class", "add") != 0)
        return 1;
...
TEST(repro_grammar_scripting_php) {
    static const char src[] =
        ...
        "    }\n"
        "}\n";
    if (single_file_battery("PHP", src, PMM_LANG_PHP, "Calculator.php",
                            "Method", "Class", "add") != 0)
        return 1;
...
TEST(repro_grammar_scripting_javascript) {
    static const char src[] =
        ...
        "    }\n"
        "}\n";
    if (single_file_battery("JavaScript", src, PMM_LANG_JAVASCRIPT, "calc.js",
                            "Function", "Class", "add") != 0)
        return 1;
...
TEST(repro_grammar_scripting_typescript) {
    static const char src[] =
        ...
        "    }\n"
        "}\n";
    if (single_file_battery("TypeScript", src, PMM_LANG_TYPESCRIPT, "calc.ts",
                            "Function", "Class", "add") != 0)
        return 1;
 ...
 * (shares the TS/JS func_kinds). Uses PMM_LANG_TSX with a .tsx file.
 */
TEST(repro_grammar_scripting_tsx) {
    static const char src[] =
        ...
        "    }\n"
        "}\n";
    if (single_file_battery("TSX", src, PMM_LANG_TSX, "Widget.tsx",
                            "Function", "Class", "add") != 0)
        return 1;
...
TEST(repro_grammar_scripting_lua) {
    static const char src[] =
        ...
        "    return add(x, 1)\n"
        "end\n";
    if (single_file_battery("Lua", src, PMM_LANG_LUA, "calc.lua",
                            "Function", NULL, "add") != 0)
        return 1;
...
TEST(repro_grammar_scripting_perl) {
    static const char src[] =
        ...
        "    return add($x, 1);\n"
        "}\n";
    if (single_file_battery("Perl", src, PMM_LANG_PERL, "calc.pl",
                            "Function", NULL, "add") != 0)
        return 1;
...
TEST(repro_grammar_scripting_r) {
    static const char src[] =
        ...
        "    add(x, 1)\n"
        "}\n";
    if (single_file_battery("R", src, PMM_LANG_R, "calc.R",
                            "Function", NULL, "add") != 0)
        return 1;
...
TEST(repro_grammar_scripting_julia) {
    static const char src[] =
        ...
        "    return add(x, 1)\n"
        "end\n";
    if (single_file_battery("Julia", src, PMM_LANG_JULIA, "calc.jl",
                            "Function", NULL, "add") != 0)
        return 1;
...
TEST(repro_grammar_scripting_groovy) {
    static const char src[] =
        ...
        "    }\n"
        "}\n";
    if (single_file_battery("Groovy", src, PMM_LANG_GROOVY, "Calculator.groovy",
                            "Method", "Class", "add") != 0)
        return 1;
 ...
 * CALLS edge is produced. RED IS the deliverable. Uses PMM_LANG_DART.
 */
TEST(repro_grammar_scripting_dart) {
    static const char src[] =
        ...
        "  }\n"
        "}\n";
    if (single_file_battery("Dart", src, PMM_LANG_DART, "calc.dart",
                            "Method", "Class", "add") != 0)
        return 1;
