 ...
 * comment.
 *
 * Languages covered (12) and the PMM_LANG_* enum each uses (all verified in
 ...
 *   GoTemplate  -> PMM_LANG_GOTEMPLATE
 *   JSDoc       -> PMM_LANG_JSDOC
 *
 * BATTERY DIMENSIONS
 * ------------------
 ...
 *                          pmm_find_enclosing_func relies on the same node being
...
TEST(repro_grammar_web_html) {
    static const char src[] =
        ...
        "</body>\n"
        "</html>\n";
    return structural_base_battery("HTML", src, PMM_LANG_HTML, "index.html");
}
...
TEST(repro_grammar_web_css) {
    static const char src[] =
        ...
        "  padding: 1rem;\n"
        "}\n";
    return callable_battery("CSS", src, PMM_LANG_CSS, "style.css",
                            NULL, "url");
}
...
TEST(repro_grammar_web_scss) {
    static const char src[] =
        ...
        "  background: #fff;\n"
        "}\n";
    if (callable_battery("SCSS", src, PMM_LANG_SCSS, "styles.scss",
...
TEST(repro_grammar_web_vue) {
    static const char src[] =
        ...
        "</style>\n";
    return structural_base_battery("Vue", src, PMM_LANG_VUE, "Hello.vue");
}
...
TEST(repro_grammar_web_svelte) {
    ...
    return structural_base_battery("Svelte", src, PMM_LANG_SVELTE,
                                   "Counter.svelte");
}
...
TEST(repro_grammar_web_astro) {
    static const char src[] =
        ...
        "  </body>\n"
        "</html>\n";
    return structural_base_battery("Astro", src, PMM_LANG_ASTRO,
                                   "index.astro");
}
...
TEST(repro_grammar_web_graphql) {
    static const char src[] =
        ...
        "  user(id: ID!): User\n"
        "}\n";
    return schema_battery("GraphQL", src, PMM_LANG_GRAPHQL, "schema.graphql",
                          "Class", "Field");
}
...
TEST(repro_grammar_web_protobuf) {
    static const char src[] =
        ...
        "}\n";
    return schema_battery("Protobuf", src, PMM_LANG_PROTOBUF, "user.proto",
                          "Function", "Class");
}
...
TEST(repro_grammar_web_thrift) {
    static const char src[] =
        ...
        "}\n";
    return schema_battery("Thrift", src, PMM_LANG_THRIFT, "user.thrift",
                          "Function", "Class");
}
...
TEST(repro_grammar_web_prisma) {
    static const char src[] =
        ...
        "}\n";
    return schema_battery("Prisma", src, PMM_LANG_PRISMA, "schema.prisma",
                          "Class", "Field");
}
...
TEST(repro_grammar_web_gotemplate) {
    static const char src[] =
        ...
        "  {{ template \"greeting\" . }}\n"
        "{{ end }}\n";
    if (callable_battery("GoTemplate", src, PMM_LANG_GOTEMPLATE,
...
TEST(repro_grammar_web_jsdoc) {
    static const char src[] =
        ...
        " */\n";
    return structural_base_battery("JSDoc", src, PMM_LANG_JSDOC, "api.jsdoc");
}
