...
The tree-sitter C runtime is vendored in `internal/pmm/vendored/ts_runtime/`.

- **Project:** [tree-sitter](https://github.com/tree-sitter/tree-sitter)
- **License:** MIT
- **Copyright:** (c) 2018–2024 Max Brunsfeld

**Local modification** (`internal/pmm/vendored/ts_runtime/src/stack.c`, #913): a
single PMM patch bounds the recursive ambiguity-merge in `stack_node_add_link`
at `PMM_TS_STACK_MERGE_MAX_DEPTH` (512). Deeply nested grammar-ambiguous input
...
`MAX_LINK_COUNT` bail-out. The change is clearly marked `// PMM patch:` inline.
**On re-vendor (e.g. ts_runtime → 0.26.x): re-apply this bound.**

The shared scanner helpers in `internal/pmm/vendored/common/` (`scanner.h`,
...
`internal/pmm/vendored/common/`.

The core runtime headers in `internal/pmm/vendored/common/tree_sitter/`
...
159 pre-generated parsers are vendored in `internal/pmm/vendored/grammars/<lang>/`
...
[`internal/pmm/vendored/grammars/MANIFEST.md`](internal/pmm/vendored/grammars/MANIFEST.md).
...
- **Vendored at:** `internal/pmm/vendored/grammars/objectscript_udl/`, `internal/pmm/vendored/grammars/objectscript_routine/`
...
| LZ4 | `internal/pmm/vendored/lz4/` | BSD-2-Clause (library files) | [lz4/lz4](https://github.com/lz4/lz4) |
| Zstandard | `internal/pmm/vendored/zstd/` | BSD-3-Clause (dual BSD / GPLv2 — BSD selected) | [facebook/zstd](https://github.com/facebook/zstd) |
| simplecpp | `internal/pmm/vendored/simplecpp/` | 0BSD | [danmar/simplecpp](https://github.com/danmar/simplecpp) |
| Verstable | `internal/pmm/vendored/verstable/` | MIT | [JacksonAllan/Verstable](https://github.com/JacksonAllan/Verstable) |
| wyhash | `internal/pmm/vendored/wyhash/` | Unlicense (public domain) | [wangyi-fudan/wyhash](https://github.com/wangyi-fudan/wyhash) |
...
PMM's 4 KiB path support). Patches must be reapplied on every upstream
...
The Hybrid LSP layer (`internal/pmm/lsp/`) is an original C implementation
...
The stdlib type registries in `internal/pmm/lsp/generated/` were produced as
follows:
