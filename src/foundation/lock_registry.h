 ...
 */
#ifndef PMM_LOCK_REGISTRY_H
#define PMM_LOCK_REGISTRY_H
...
#define PMM_LOCK_REGISTRY_NAME_CAP 80U

typedef struct pmm_lock_registry pmm_lock_registry_t;
typedef struct pmm_lock_lease pmm_lock_lease_t;
typedef atomic_bool pmm_lock_cancel_token_t;
...
/* deadline_ms is an absolute pmm_now_ms() deadline; UINT64_MAX means no
