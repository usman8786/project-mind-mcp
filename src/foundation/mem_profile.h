 ...
 *
 * Off unless PMM_MEM_PROFILE=1. All tables are fixed-capacity and allocated
 ...
 */
#ifndef PMM_MEM_PROFILE_H
#define PMM_MEM_PROFILE_H

#include <stdbool.h>
#include <stddef.h>

/* Gate: PMM_MEM_PROFILE=1. Read once, cached. */
bool pmm_mem_profile_enabled(void);

/* Minimum allocation size recorded, from PMM_MEM_PROFILE_MIN (bytes). */
