...
#ifndef PMM_FOUNDATION_MACOS_ACL_H
#define PMM_FOUNDATION_MACOS_ACL_H
...
bool pmm_macos_extended_acl_fd_is_empty(int fd);
...
bool pmm_macos_extended_acl_fd_is_deny_only(int fd);
...
bool pmm_macos_extended_acl_fd_clear(int fd);
