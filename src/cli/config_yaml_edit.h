 ...
 */
#ifndef PMM_CONFIG_YAML_EDIT_H
#define PMM_CONFIG_YAML_EDIT_H
 ...
 * "<file_path>.pmm-yaml.lock" regular file, created with mode 0600 and held by
 ...
 * pmm_yaml_encode_double_quoted_scalar(). Full-line comments remain allowed.
 *
 ...
 * return PMM_YAML_IDENTITY_EDIT_FOREIGN. Errors return
 ...
 * pmm_yaml_encode_double_quoted_scalar().
 *
 ...
 * PMM_YAML_IDENTITY_EDIT_FOREIGN. Removal deletes only the exact canonical
 ...
 * concurrency failures return PMM_YAML_IDENTITY_EDIT_ERROR byte-identically. */
enum {
    PMM_YAML_IDENTITY_EDIT_ERROR = -1,
    PMM_YAML_IDENTITY_EDIT_OK = 0,
    PMM_YAML_IDENTITY_EDIT_FOREIGN = 1
};
...
typedef void (*pmm_yaml_precommit_test_hook_t)(const char *file_path, void *context);
