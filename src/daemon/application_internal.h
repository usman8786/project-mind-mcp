 ...
 */
#ifndef PMM_DAEMON_APPLICATION_INTERNAL_H
#define PMM_DAEMON_APPLICATION_INTERNAL_H
...
bool pmm_daemon_application_session_retains_store_for_test(
    const pmm_daemon_runtime_application_session_t *session);
...
#endif /* PMM_DAEMON_APPLICATION_INTERNAL_H */
