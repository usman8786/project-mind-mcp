/*
 * ipc.h — Authenticated local transport for the PMM daemon.
 *
 ...
 */
#ifndef PMM_DAEMON_IPC_H
#define PMM_DAEMON_IPC_H
...
typedef struct pmm_daemon_ipc_endpoint pmm_daemon_ipc_endpoint_t;
typedef struct pmm_daemon_ipc_listener pmm_daemon_ipc_listener_t;
typedef struct pmm_daemon_ipc_connection pmm_daemon_ipc_connection_t;
typedef struct pmm_daemon_ipc_startup_lock pmm_daemon_ipc_startup_lock_t;
typedef struct pmm_daemon_ipc_local_transition pmm_daemon_ipc_local_transition_t;
typedef struct pmm_daemon_ipc_participant_guard pmm_daemon_ipc_participant_guard_t;
typedef struct pmm_daemon_ipc_lifetime_reservation pmm_daemon_ipc_lifetime_reservation_t;

/* A receive wait with no wall-clock expiry. The wait remains interruptible by
 * peer EOF and pmm_daemon_ipc_connection_interrupt(). This is intentionally a
 ...
 * arriving. */
#define PMM_DAEMON_IPC_WAIT_FOREVER UINT32_MAX
 ...
 * receive_frame also accepts PMM_DAEMON_IPC_WAIT_FOREVER. */
...
int pmm_daemon_ipc_local_transition_try_acquire(const pmm_daemon_ipc_endpoint_t *endpoint,
...
int pmm_daemon_ipc_local_transition_lifetime_probe(
    const pmm_daemon_ipc_endpoint_t *endpoint, const pmm_daemon_ipc_local_transition_t *transition);
