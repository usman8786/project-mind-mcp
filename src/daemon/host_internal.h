 ...
 */
#ifndef PMM_DAEMON_HOST_INTERNAL_H
#define PMM_DAEMON_HOST_INTERNAL_H
...
typedef bool (*pmm_daemon_host_cleanup_release_for_test_fn)(void *context);
...
bool pmm_daemon_host_state_prepare_for_test(const struct pmm_daemon_ipc_endpoint *endpoint);
...
} pmm_daemon_host_http_reconcile_test_result_t;
...
} pmm_daemon_host_http_free_refusal_test_result_t;
...
#endif /* PMM_DAEMON_HOST_INTERNAL_H */
