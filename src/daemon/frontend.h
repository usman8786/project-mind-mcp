 ...
 */
#ifndef PMM_DAEMON_FRONTEND_H
#define PMM_DAEMON_FRONTEND_H
...
typedef struct pmm_daemon_maintenance_monitor pmm_daemon_maintenance_monitor_t;
...
typedef bool (*pmm_daemon_maintenance_cancel_fn)(void *context);
