 ...
 */
#ifndef PMM_AST_PROFILE_H
#define PMM_AST_PROFILE_H
 ...
 * buf must be at least PMM_AST_PROFILE_BUF bytes. */
enum { PMM_AST_PROFILE_BUF = 200 };
 ...
 * out must have PMM_AST_PROFILE_DIMS elements. */
void pmm_ast_profile_to_vector(const pmm_ast_profile_t *p, float *out);

#endif /* PMM_AST_PROFILE_H */
