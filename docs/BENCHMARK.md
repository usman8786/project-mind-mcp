# Project Mind MCP -- v0.3.0 Language Benchmark
...
| 21 | Go | project-mind-mcp (self) | 2,259 | 6,561 | 10.5/12 | 87% | 2 |
...
**Project**: `project-mind-mcp` | **Repo**: self
...
PHP runs through a Light Semantic Pass (`internal/pmm/lsp/php_lsp.c`,
