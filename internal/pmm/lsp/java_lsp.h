#ifndef PMM_LSP_JAVA_LSP_H
#define PMM_LSP_JAVA_LSP_H
...
enum {
    PMM_JAVA_IMPORT_TYPE = 0,      /* import com.foo.Bar; — type import */
    PMM_JAVA_IMPORT_STATIC = 1,    /* import static com.foo.Bar.method; */
    PMM_JAVA_IMPORT_ON_DEMAND = 2, /* import com.foo.*; — package on-demand */
    PMM_JAVA_IMPORT_STATIC_OD = 3, /* import static com.foo.Bar.*; */
};
...
typedef struct {
    ...
    /* Import map. Each entry is one of PMM_JAVA_IMPORT_*.
 ...
 * pmm_type_unknown(); never returns NULL. */
 ...
 * type, or pmm_type_unknown() on miss. */
