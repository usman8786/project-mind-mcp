#ifndef PMM_LSP_PY_LSP_H
#define PMM_LSP_PY_LSP_H
...
typedef struct {
    ...
    // deeply-nested/cyclic files; see pmm_lsp_max_walk_depth). Zero via memset.
    int walk_depth;
    ...
    // Debug mode (PMM_LSP_DEBUG env, shared across all language LSPs).
    bool debug;
} PyLSPContext;
...
// Mirrors pmm_run_go_lsp / pmm_run_c_lsp.
