#ifndef PMM_LSP_TS_LSP_H
#define PMM_LSP_TS_LSP_H
...
// evaluation within a single file. One context per pmm_run_ts_lsp invocation.
//
...
// Evaluate the type of a TS/JS expression node. Returns pmm_type_unknown() on miss.
