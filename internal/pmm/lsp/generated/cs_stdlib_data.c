...
#define REG_EXTENSION(qn_, short_name_, recv_, ret_type_)            \
    do {                                                             \
        ...
        {                                                            \
            ...
            rets[1] = NULL;                                          \
            const char **pnames =                                    \
                (const char **)pmm_arena_alloc(arena, 2 * sizeof(*pnames)); \
            pnames[0] = "this";                                       \
            pnames[1] = NULL;                                        \
            const CBMType **ptypes =                                 \
                (const CBMType **)pmm_arena_alloc(arena, 2 * sizeof(*ptypes)); \
            ptypes[0] = (recv_);                                     \
            ptypes[1] = NULL;                                        \
            rf.signature = pmm_type_func(arena, pnames, ptypes, rets); \
        }                                                            \
        pmm_registry_add_func(reg, rf);                              \
    } while (0)

#define OBJ() pmm_type_named(arena, "System.Object")
#define STR() pmm_type_named(arena, "System.String")
#define INT() pmm_type_named(arena, "System.Int32")
#define LONG_T() pmm_type_named(arena, "System.Int64")
#define BOOL_T() pmm_type_named(arena, "System.Boolean")
#define DBL() pmm_type_named(arena, "System.Double")
#define VOID_T() pmm_type_named(arena, "System.Void")
#define UNK() pmm_type_unknown()

void pmm_csharp_stdlib_register(CBMTypeRegistry *reg, CBMArena *arena) {
    ...
    REG_METHOD("System.Object", "GetType", pmm_type_named(arena, "System.Type"));
    ...
    REG_METHOD("System.String", "Split",
               pmm_type_template(arena, "System.Array",
    ...
    REG_METHOD("System.String", "ToCharArray",
               pmm_type_template(arena, "System.Array",
                                 (const CBMType *[]){pmm_type_named(arena, "System.Char"), NULL},
                                 1));
    ...
    REG_STATIC("System.Convert", "ToSingle", pmm_type_named(arena, "System.Single"));
    REG_STATIC("System.Convert", "ChangeType", OBJ());

    /* ── System.Guid ───────────────────────────────────────────── */
    REG_TYPE("System.Guid", "Guid", false, valuetype_parent);
    REG_STATIC("System.Guid", "NewGuid", pmm_type_named(arena, "System.Guid"));
    REG_STATIC("System.Guid", "Parse", pmm_type_named(arena, "System.Guid"));
    ...
    REG_STATIC("System.DateTime", "Now", pmm_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "UtcNow", pmm_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "Today", pmm_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "Parse", pmm_type_named(arena, "System.DateTime"));
    REG_STATIC("System.DateTime", "TryParse", BOOL_T());
    REG_METHOD("System.DateTime", "AddDays", pmm_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddHours", pmm_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddMinutes", pmm_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddSeconds", pmm_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "AddMilliseconds", pmm_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "Subtract", pmm_type_named(arena, "System.TimeSpan"));
    REG_METHOD("System.DateTime", "ToString", STR());
    REG_METHOD("System.DateTime", "ToUniversalTime", pmm_type_named(arena, "System.DateTime"));
    REG_METHOD("System.DateTime", "ToLocalTime", pmm_type_named(arena, "System.DateTime"));
    ...
    REG_STATIC("System.DateTimeOffset", "Now", pmm_type_named(arena, "System.DateTimeOffset"));
    REG_STATIC("System.DateTimeOffset", "UtcNow", pmm_type_named(arena, "System.DateTimeOffset"));
    ...
    REG_STATIC("System.IO.File", "ReadAllBytes",
               pmm_type_template(arena, "System.Array",
                                 (const CBMType *[]){pmm_type_named(arena, "System.Byte"), NULL},
                                 1));
    ...
    REG_STATIC("System.IO.File", "Open", pmm_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "OpenRead", pmm_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "OpenWrite", pmm_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "Create", pmm_type_named(arena, "System.IO.FileStream"));
    REG_STATIC("System.IO.File", "ReadAllTextAsync",
               pmm_type_template(arena, "System.Threading.Tasks.Task",
                                 (const CBMType *[]){STR(), NULL}, 1));
    REG_STATIC("System.IO.File", "WriteAllTextAsync",
               pmm_type_named(arena, "System.Threading.Tasks.Task"));
    ...
    REG_STATIC("System.IO.Directory", "CreateDirectory",
               pmm_type_named(arena, "System.IO.DirectoryInfo"));
    ...
    REG_STATIC("System.IO.Directory", "EnumerateFiles",
               pmm_type_template(arena, "System.Collections.Generic.IEnumerable",
                                 (const CBMType *[]){STR(), NULL}, 1));
    ...
    REG_METHOD("System.Text.StringBuilder", "Append",
               pmm_type_named(arena, "System.Text.StringBuilder"));
    ...
    REG_STATIC("System.Text.Encoding", "UTF8", pmm_type_named(arena, "System.Text.Encoding"));
    REG_STATIC("System.Text.Encoding", "ASCII", pmm_type_named(arena, "System.Text.Encoding"));
    REG_STATIC("System.Text.Encoding", "Unicode", pmm_type_named(arena, "System.Text.Encoding"));
    ...
    REG_STATIC("System.Text.RegularExpressions.Regex", "Match",
               pmm_type_named(arena, "System.Text.RegularExpressions.Match"));
    REG_STATIC("System.Text.RegularExpressions.Regex", "Matches",
               pmm_type_named(arena, "System.Text.RegularExpressions.MatchCollection"));
    ...
    REG_METHOD("System.Collections.Generic.IEnumerable", "GetEnumerator",
               pmm_type_template(arena, "System.Collections.Generic.IEnumerator",
                                 (const CBMType *[]){pmm_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Collections.Generic.List", "Find", pmm_type_type_param(arena, "T"));
    REG_METHOD("System.Collections.Generic.List", "FindAll",
               pmm_type_template(arena, "System.Collections.Generic.List",
                                 (const CBMType *[]){pmm_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Collections.Generic.IDictionary", "Keys",
               pmm_type_template(arena, "System.Collections.Generic.ICollection",
                                 (const CBMType *[]){pmm_type_type_param(arena, "TKey"), NULL},
                                 1));
    REG_METHOD("System.Collections.Generic.IDictionary", "Values",
               pmm_type_template(arena, "System.Collections.Generic.ICollection",
                                 (const CBMType *[]){pmm_type_type_param(arena, "TValue"), NULL},
                                 1));
    ...
    REG_METHOD("System.Collections.Generic.Queue", "Dequeue", pmm_type_type_param(arena, "T"));
    REG_METHOD("System.Collections.Generic.Queue", "Peek", pmm_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Collections.Generic.Stack", "Pop", pmm_type_type_param(arena, "T"));
    REG_METHOD("System.Collections.Generic.Stack", "Peek", pmm_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Collections.Generic.KeyValuePair", "Key",
               pmm_type_type_param(arena, "TKey"));
    REG_METHOD("System.Collections.Generic.KeyValuePair", "Value",
               pmm_type_type_param(arena, "TValue"));
    ...
    REG_METHOD("System.Span", "Slice",
               pmm_type_template(arena, "System.Span",
                                 (const CBMType *[]){pmm_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.ReadOnlySpan", "Slice",
               pmm_type_template(arena, "System.ReadOnlySpan",
                                 (const CBMType *[]){pmm_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Nullable", "Value", pmm_type_type_param(arena, "T"));
    REG_METHOD("System.Nullable", "GetValueOrDefault", pmm_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Threading.Tasks.Task", "Exception",
               pmm_type_named(arena, "System.AggregateException"));
    ...
    REG_METHOD("System.Threading.CancellationTokenSource", "Token",
               pmm_type_named(arena, "System.Threading.CancellationToken"));
    ...
    REG_METHOD("System.Exception", "InnerException",
               pmm_type_named(arena, "System.Exception"));
    ...
    REG_EXTENSION("System.Linq.Enumerable.Where", "Where",
                   pmm_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const CBMType *[]){pmm_type_type_param(arena, "T"), NULL},
                                     1),
                   pmm_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const CBMType *[]){pmm_type_type_param(arena, "T"), NULL},
                                     1));
    ...
    REG_EXTENSION("System.Linq.Enumerable.OrderBy", "OrderBy",
                   pmm_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const CBMType *[]){pmm_type_type_param(arena, "T"), NULL},
                                     1),
                   pmm_type_template(arena, "System.Linq.IOrderedEnumerable",
                                     (const CBMType *[]){pmm_type_type_param(arena, "T"), NULL},
                                     1));
    ...
    REG_EXTENSION("System.Linq.Enumerable.ToDictionary", "ToDictionary",
                   pmm_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const CBMType *[]){pmm_type_type_param(arena, "T"), NULL},
                                     1),
                   pmm_type_template(arena, "System.Collections.Generic.Dictionary",
                                     (const CBMType *[]){UNK(), UNK(), NULL}, 2));
    REG_EXTENSION("System.Linq.Enumerable.ToHashSet", "ToHashSet",
                   pmm_type_template(arena, "System.Collections.Generic.IEnumerable",
                                     (const CBMType *[]){pmm_type_type_param(arena, "T"), NULL},
                                     1),
                   pmm_type_template(arena, "System.Collections.Generic.HashSet",
                                     (const CBMType *[]){pmm_type_type_param(arena, "T"), NULL},
                                     1));
    ...
    REG_STATIC("System.Text.Json.JsonDocument", "Parse",
               pmm_type_named(arena, "System.Text.Json.JsonDocument"));
    ...
    REG_METHOD("System.Net.Http.HttpResponseMessage", "EnsureSuccessStatusCode",
               pmm_type_named(arena, "System.Net.Http.HttpResponseMessage"));
    ...
    REG_METHOD("System.Net.Http.HttpResponseMessage", "Content",
               pmm_type_named(arena, "System.Net.Http.HttpContent"));
    ...
    REG_METHOD("Microsoft.Extensions.Logging.ILogger", "BeginScope",
               pmm_type_named(arena, "System.IDisposable"));
    ...
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "Ok",
               pmm_type_named(arena, "Microsoft.AspNetCore.Mvc.OkObjectResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "NotFound",
               pmm_type_named(arena, "Microsoft.AspNetCore.Mvc.NotFoundObjectResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "BadRequest",
               pmm_type_named(arena, "Microsoft.AspNetCore.Mvc.BadRequestObjectResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "StatusCode",
               pmm_type_named(arena, "Microsoft.AspNetCore.Mvc.IActionResult"));
    REG_METHOD("Microsoft.AspNetCore.Mvc.ControllerBase", "Json",
               pmm_type_named(arena, "Microsoft.AspNetCore.Mvc.JsonResult"));
    ...
    REG_METHOD("Microsoft.EntityFrameworkCore.DbSet", "Find", pmm_type_type_param(arena, "T"));
    REG_METHOD("Microsoft.EntityFrameworkCore.DbSet", "FindAsync",
               pmm_type_template(arena, "System.Threading.Tasks.ValueTask",
                                 (const CBMType *[]){pmm_type_type_param(arena, "T"), NULL}, 1));
    ...
    REG_METHOD("System.Lazy", "Value", pmm_type_type_param(arena, "T"));
    ...
    REG_GENERIC_TYPE_P1("System.Func", "Func", false,
                         "System.Delegate", single_t_params);
    REG_METHOD("System.Func", "Invoke", pmm_type_type_param(arena, "T"));
    ...
    REG_METHOD("System.Tuple", "Item1", pmm_type_type_param(arena, "T"));
    ...
    REG_STATIC("System.Diagnostics.Stopwatch", "StartNew",
               pmm_type_named(arena, "System.Diagnostics.Stopwatch"));
    ...
    REG_METHOD("System.Diagnostics.Stopwatch", "Elapsed",
               pmm_type_named(arena, "System.TimeSpan"));
