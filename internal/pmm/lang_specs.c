 ...
 * `signature` (type annotations) is suppressed in pmm_resolve_func_name so it never doubles. */
 ...
 * def-vs-call distinction happens in pmm_resolve_func_name (returns NULL for a
 ...
 * the PMM_LANG_FSHARP branch in pmm_resolve_func_name. */
...
static const CBMEmbeddedLangSpec vue_embedded_imports[] = {
    {"script_element", "raw_text", PMM_LANG_JAVASCRIPT},
    {NULL, NULL, 0},
};
...
static const CBMEmbeddedLangSpec astro_embedded_imports[] = {
    ...
    {"frontmatter", "frontmatter_js_block", PMM_LANG_JAVASCRIPT},
    {"script_element", "raw_text", PMM_LANG_JAVASCRIPT},
    {NULL, NULL, 0},
};
 ...
 * gate is in pmm_resolve_func_name (returns NULL for a non-def list). */
 ...
 * pmm_resolve_func_name climbs to the parent for naming. A function application
...
static const CBMLangSpec lang_specs[PMM_LANG_COUNT] = {
    // PMM_LANG_GO
    [PMM_LANG_GO] = {PMM_LANG_GO, go_func_types, go_class_types, go_field_types, go_module_types,
    ...
    // PMM_LANG_PYTHON
    [PMM_LANG_PYTHON] = {PMM_LANG_PYTHON, py_func_types, py_class_types, empty_types,
    ...
    // PMM_LANG_JAVASCRIPT
    [PMM_LANG_JAVASCRIPT] =
        {PMM_LANG_JAVASCRIPT, js_func_types, js_class_types, empty_types, js_module_types,
    ...
    // PMM_LANG_TYPESCRIPT
    [PMM_LANG_TYPESCRIPT] = {PMM_LANG_TYPESCRIPT, ts_func_types, ts_class_types, empty_types,
    ...
    // PMM_LANG_TSX
    [PMM_LANG_TSX] =
        {PMM_LANG_TSX, ts_func_types, ts_class_types, empty_types, js_module_types, js_call_types,
    ...
    // PMM_LANG_RUST
    [PMM_LANG_RUST] = {PMM_LANG_RUST, rust_func_types, rust_class_types, rust_field_types,
    ...
    // PMM_LANG_JAVA
    [PMM_LANG_JAVA] = {PMM_LANG_JAVA, java_func_types, java_class_types, java_field_types,
    ...
    // PMM_LANG_CPP
    [PMM_LANG_CPP] = {PMM_LANG_CPP, cpp_func_types, cpp_class_types, cpp_field_types,
    ...
    // PMM_LANG_CSHARP
    [PMM_LANG_CSHARP] = {PMM_LANG_CSHARP, cs_func_types, cs_class_types, cs_field_types,
    ...
    // PMM_LANG_PHP
    [PMM_LANG_PHP] = {PMM_LANG_PHP, php_func_types, php_class_types, empty_types, php_module_types,
    ...
    // PMM_LANG_LUA
    [PMM_LANG_LUA] = {PMM_LANG_LUA, lua_func_types, empty_types, empty_types, lua_module_types,
    ...
    // PMM_LANG_SCALA
    [PMM_LANG_SCALA] = {PMM_LANG_SCALA, scala_func_types, scala_class_types, empty_types,
    ...
    // PMM_LANG_KOTLIN
    [PMM_LANG_KOTLIN] = {PMM_LANG_KOTLIN, kotlin_func_types, kotlin_class_types, empty_types,
    ...
    // PMM_LANG_RUBY
    [PMM_LANG_RUBY] = {PMM_LANG_RUBY, ruby_func_types, ruby_class_types, empty_types,
    ...
    // PMM_LANG_C
    [PMM_LANG_C] = {PMM_LANG_C, c_func_types, c_class_types, c_field_types, c_module_types,
    ...
    // PMM_LANG_BASH
    [PMM_LANG_BASH] = {PMM_LANG_BASH, bash_func_types, empty_types, empty_types, bash_module_types,
    ...
    // PMM_LANG_ZIG
    [PMM_LANG_ZIG] = {PMM_LANG_ZIG, zig_func_types, zig_class_types, zig_field_types,
    ...
    // PMM_LANG_ELIXIR
    [PMM_LANG_ELIXIR] = {PMM_LANG_ELIXIR, elixir_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_HASKELL
    [PMM_LANG_HASKELL] = {PMM_LANG_HASKELL, haskell_func_types, haskell_class_types, empty_types,
    ...
    // PMM_LANG_OCAML
    [PMM_LANG_OCAML] = {PMM_LANG_OCAML, ocaml_func_types, ocaml_class_types, empty_types,
    ...
    // PMM_LANG_OBJC
    [PMM_LANG_OBJC] = {PMM_LANG_OBJC, objc_func_types, objc_class_types, objc_field_types,
    ...
    // PMM_LANG_SWIFT
    [PMM_LANG_SWIFT] = {PMM_LANG_SWIFT, swift_func_types, swift_class_types, swift_field_types,
    ...
    // PMM_LANG_DART
    [PMM_LANG_DART] = {PMM_LANG_DART, dart_func_types, dart_class_types, dart_field_types,
    ...
    // PMM_LANG_PERL
    [PMM_LANG_PERL] = {PMM_LANG_PERL, perl_func_types, empty_types, empty_types, perl_module_types,
    ...
    // PMM_LANG_GROOVY
    [PMM_LANG_GROOVY] = {PMM_LANG_GROOVY, groovy_func_types, groovy_class_types, empty_types,
    ...
    // PMM_LANG_ERLANG
    [PMM_LANG_ERLANG] = {PMM_LANG_ERLANG, erlang_func_types, erlang_class_types, empty_types,
    ...
    // PMM_LANG_R
    [PMM_LANG_R] = {PMM_LANG_R, r_func_types, empty_types, empty_types, r_module_types,
    ...
    // PMM_LANG_HTML
    [PMM_LANG_HTML] = {PMM_LANG_HTML, empty_types, empty_types, empty_types, html_module_types,
    ...
    // PMM_LANG_CSS
    [PMM_LANG_CSS] = {PMM_LANG_CSS, empty_types, empty_types, empty_types, css_module_types,
    ...
    // PMM_LANG_SCSS
    [PMM_LANG_SCSS] = {PMM_LANG_SCSS, scss_func_types, empty_types, empty_types, scss_module_types,
    ...
    // PMM_LANG_YAML
    [PMM_LANG_YAML] = {PMM_LANG_YAML, empty_types, empty_types, empty_types, yaml_module_types,
    ...
    // PMM_LANG_TOML
    [PMM_LANG_TOML] = {PMM_LANG_TOML, empty_types, toml_class_types, empty_types, toml_module_types,
    ...
    // PMM_LANG_HCL
    [PMM_LANG_HCL] = {PMM_LANG_HCL, empty_types, hcl_class_types, empty_types, hcl_module_types,
    ...
    // PMM_LANG_SQL
    [PMM_LANG_SQL] = {PMM_LANG_SQL, sql_func_types, sql_class_types, sql_field_types,
    ...
    // PMM_LANG_DOCKERFILE
    [PMM_LANG_DOCKERFILE] = {PMM_LANG_DOCKERFILE, empty_types, empty_types, empty_types,
    ...
    // PMM_LANG_CLOJURE
    [PMM_LANG_CLOJURE] = {PMM_LANG_CLOJURE, clojure_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_FSHARP
    [PMM_LANG_FSHARP] = {PMM_LANG_FSHARP, fsharp_func_types, fsharp_class_types, empty_types,
    ...
    // PMM_LANG_JULIA
    [PMM_LANG_JULIA] = {PMM_LANG_JULIA, julia_func_types, julia_class_types, empty_types,
    ...
    // PMM_LANG_VIMSCRIPT
    [PMM_LANG_VIMSCRIPT] = {PMM_LANG_VIMSCRIPT, vim_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_NIX
    [PMM_LANG_NIX] = {PMM_LANG_NIX, nix_func_types, empty_types, empty_types, nix_module_types,
    ...
    // PMM_LANG_COMMONLISP
    [PMM_LANG_COMMONLISP] = {PMM_LANG_COMMONLISP, commonlisp_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_ELM
    [PMM_LANG_ELM] = {PMM_LANG_ELM, elm_func_types, elm_class_types, empty_types, elm_module_types,
    ...
    // PMM_LANG_FORTRAN
    [PMM_LANG_FORTRAN] = {PMM_LANG_FORTRAN, fortran_func_types, fortran_class_types, empty_types,
    ...
    // PMM_LANG_CUDA (reuses C++ node types)
    [PMM_LANG_CUDA] = {PMM_LANG_CUDA, cpp_func_types, cpp_class_types, cpp_field_types,
                       cpp_module_types, cpp_call_types, cpp_import_types, cpp_import_types,
                       cpp_branch_types, cpp_var_types, cpp_assign_types, cpp_throw_types, NULL,
                       empty_types, cpp_env_funcs, NULL, tree_sitter_cuda, NULL},

    // PMM_LANG_COBOL
    [PMM_LANG_COBOL] = {PMM_LANG_COBOL, cobol_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_VERILOG
    [PMM_LANG_VERILOG] = {PMM_LANG_VERILOG, verilog_func_types, verilog_class_types, empty_types,
    ...
    // PMM_LANG_EMACSLISP
    [PMM_LANG_EMACSLISP] = {PMM_LANG_EMACSLISP, elisp_func_types, empty_types, empty_types,
                            elisp_module_types, elisp_call_types, empty_types, empty_types,
                            empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                            NULL, NULL, tree_sitter_elisp, NULL},

    // PMM_LANG_JSON
    [PMM_LANG_JSON] = {PMM_LANG_JSON, empty_types, empty_types, empty_types, json_module_types,
    ...
    // PMM_LANG_XML
    [PMM_LANG_XML] = {PMM_LANG_XML, empty_types, xml_class_types, empty_types, xml_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_xml, NULL},

    // PMM_LANG_MARKDOWN
    [PMM_LANG_MARKDOWN] = {PMM_LANG_MARKDOWN, empty_types, markdown_class_types, empty_types,
                           markdown_module_types, empty_types, empty_types, empty_types,
                           empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                           NULL, NULL, tree_sitter_markdown, NULL},

    // PMM_LANG_MAKEFILE
    [PMM_LANG_MAKEFILE] = {PMM_LANG_MAKEFILE, makefile_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_CMAKE
    [PMM_LANG_CMAKE] = {PMM_LANG_CMAKE, cmake_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_PROTOBUF
    [PMM_LANG_PROTOBUF] = {PMM_LANG_PROTOBUF, protobuf_func_types, protobuf_class_types,
    ...
    // PMM_LANG_GRAPHQL
    [PMM_LANG_GRAPHQL] = {PMM_LANG_GRAPHQL, empty_types, graphql_class_types, graphql_field_types,
    ...
    // PMM_LANG_VUE
    [PMM_LANG_VUE] = {PMM_LANG_VUE, empty_types, empty_types, empty_types, vue_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_vue,
                      vue_embedded_imports},

    // PMM_LANG_SVELTE
    [PMM_LANG_SVELTE] = {PMM_LANG_SVELTE, empty_types, empty_types, empty_types,
    ...
    // PMM_LANG_MESON
    [PMM_LANG_MESON] = {PMM_LANG_MESON, meson_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_GLSL (reuses C node types)
    [PMM_LANG_GLSL] = {PMM_LANG_GLSL, c_func_types, c_class_types, c_field_types, c_module_types,
                       c_call_types, c_import_types, empty_types, c_branch_types, c_var_types,
                       c_assign_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_glsl,
                       NULL},

    // PMM_LANG_INI
    [PMM_LANG_INI] = {PMM_LANG_INI, empty_types, ini_class_types, empty_types, ini_module_types,
    ...
    // PMM_LANG_MATLAB
    [PMM_LANG_MATLAB] = {PMM_LANG_MATLAB, matlab_func_types, matlab_class_types, empty_types,
    ...
    // PMM_LANG_LEAN
    [PMM_LANG_LEAN] = {PMM_LANG_LEAN, lean_func_types, lean_class_types, empty_types,
    ...
    // PMM_LANG_FORM
    [PMM_LANG_FORM] = {PMM_LANG_FORM, form_func_types, empty_types, empty_types, form_module_types,
    ...
    // PMM_LANG_MAGMA
    [PMM_LANG_MAGMA] = {PMM_LANG_MAGMA, magma_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_WOLFRAM
    [PMM_LANG_WOLFRAM] = {PMM_LANG_WOLFRAM, wolfram_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_SOLIDITY
    [PMM_LANG_SOLIDITY] = {PMM_LANG_SOLIDITY, solidity_func_types, solidity_class_types,
    ...
    // PMM_LANG_TYPST
    [PMM_LANG_TYPST] = {PMM_LANG_TYPST, typst_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_GDSCRIPT
    [PMM_LANG_GDSCRIPT] = {PMM_LANG_GDSCRIPT, gdscript_func_types, gdscript_class_types,
    ...
    // PMM_LANG_QML
    [PMM_LANG_QML] =
        {PMM_LANG_QML, ts_func_types, qml_class_types, qml_field_types, js_module_types,
    ...
    // PMM_LANG_CFSCRIPT
    [PMM_LANG_CFSCRIPT] =
        {PMM_LANG_CFSCRIPT, cfscript_func_types, empty_types, cfscript_field_types, js_module_types,
    ...
    // PMM_LANG_CFML
    [PMM_LANG_CFML] = {PMM_LANG_CFML, cfml_func_types, empty_types, empty_types, cfml_module_types,
    ...
    // PMM_LANG_GLEAM
    [PMM_LANG_GLEAM] = {PMM_LANG_GLEAM, gleam_func_types, gleam_class_types, gleam_field_types,
    ...
    // PMM_LANG_POWERSHELL
    [PMM_LANG_POWERSHELL] = {PMM_LANG_POWERSHELL, powershell_func_types, powershell_class_types,
    ...
    // PMM_LANG_PASCAL
    [PMM_LANG_PASCAL] = {PMM_LANG_PASCAL, pascal_func_types, pascal_class_types, pascal_field_types,
    ...
    // PMM_LANG_DLANG
    [PMM_LANG_DLANG] = {PMM_LANG_DLANG, d_func_types, d_class_types, d_field_types, d_module_types,
    ...
    // PMM_LANG_SCHEME
    [PMM_LANG_SCHEME] = {PMM_LANG_SCHEME, scheme_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_FENNEL
    [PMM_LANG_FENNEL] = {PMM_LANG_FENNEL, fennel_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_FISH
    [PMM_LANG_FISH] = {PMM_LANG_FISH, fish_func_types, empty_types, empty_types, fish_module_types,
    ...
    // PMM_LANG_AWK
    [PMM_LANG_AWK] = {PMM_LANG_AWK, awk_func_types, empty_types, empty_types, awk_module_types,
    ...
    // PMM_LANG_ZSH
    [PMM_LANG_ZSH] = {PMM_LANG_ZSH, zsh_func_types, empty_types, empty_types, zsh_module_types,
    ...
    // PMM_LANG_TCL
    [PMM_LANG_TCL] = {PMM_LANG_TCL, tcl_func_types, tcl_class_types, empty_types, tcl_module_types,
    ...
    // PMM_LANG_ADA
    [PMM_LANG_ADA] = {PMM_LANG_ADA, ada_func_types, ada_class_types, ada_field_types,
    ...
    // PMM_LANG_AGDA
    [PMM_LANG_AGDA] = {PMM_LANG_AGDA, agda_func_types, agda_class_types, empty_types,
    ...
    // PMM_LANG_RACKET
    [PMM_LANG_RACKET] = {PMM_LANG_RACKET, racket_func_types, racket_class_types, empty_types,
    ...
    // PMM_LANG_ODIN
    [PMM_LANG_ODIN] = {PMM_LANG_ODIN, odin_func_types, odin_class_types, odin_field_types,
    ...
    // PMM_LANG_RESCRIPT
    [PMM_LANG_RESCRIPT] = {PMM_LANG_RESCRIPT, rescript_func_types, rescript_class_types,
    ...
    // PMM_LANG_PURESCRIPT
    [PMM_LANG_PURESCRIPT] = {PMM_LANG_PURESCRIPT, purescript_func_types, purescript_class_types,
    ...
    // PMM_LANG_NICKEL
    [PMM_LANG_NICKEL] = {PMM_LANG_NICKEL, nickel_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_CRYSTAL
    [PMM_LANG_CRYSTAL] = {PMM_LANG_CRYSTAL, crystal_func_types, crystal_class_types,
    ...
    // PMM_LANG_TEAL
    [PMM_LANG_TEAL] = {PMM_LANG_TEAL, teal_func_types, teal_class_types, empty_types,
    ...
    // PMM_LANG_HARE
    [PMM_LANG_HARE] = {PMM_LANG_HARE, hare_func_types, hare_class_types, empty_types,
    ...
    // PMM_LANG_PONY
    [PMM_LANG_PONY] = {PMM_LANG_PONY, pony_func_types, pony_class_types, empty_types,
    ...
    // PMM_LANG_LUAU
    [PMM_LANG_LUAU] = {PMM_LANG_LUAU, luau_func_types, luau_class_types, empty_types,
    ...
    // PMM_LANG_JANET
    [PMM_LANG_JANET] = {PMM_LANG_JANET, empty_types, empty_types, empty_types, janet_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL,
                        tree_sitter_janet_simple, NULL},

    // PMM_LANG_SWAY
    [PMM_LANG_SWAY] = {PMM_LANG_SWAY, sway_func_types, sway_class_types, empty_types,
    ...
    // PMM_LANG_NASM
    [PMM_LANG_NASM] = {PMM_LANG_NASM, nasm_func_types, nasm_class_types, empty_types,
    ...
    // PMM_LANG_ASSEMBLY
    [PMM_LANG_ASSEMBLY] = {PMM_LANG_ASSEMBLY, assembly_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_ASTRO
    [PMM_LANG_ASTRO] = {PMM_LANG_ASTRO, empty_types, empty_types, empty_types, astro_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_astro,
                        astro_embedded_imports},

    // PMM_LANG_BLADE
    [PMM_LANG_BLADE] = {PMM_LANG_BLADE, empty_types, empty_types, empty_types, blade_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_blade,
                        NULL},

    // PMM_LANG_JUST
    [PMM_LANG_JUST] = {PMM_LANG_JUST, just_func_types, empty_types, empty_types, just_module_types,
    ...
    // PMM_LANG_WGSL
    [PMM_LANG_WGSL] = {PMM_LANG_WGSL, wgsl_func_types, wgsl_class_types, empty_types,
    ...
    // PMM_LANG_KDL
    [PMM_LANG_KDL] = {PMM_LANG_KDL, empty_types, empty_types, empty_types, kdl_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_kdl, NULL},

    // PMM_LANG_JSON5
    [PMM_LANG_JSON5] = {PMM_LANG_JSON5, empty_types, empty_types, empty_types, json5_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_json5,
                        NULL},

    // PMM_LANG_JSONNET
    [PMM_LANG_JSONNET] = {PMM_LANG_JSONNET, jsonnet_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_RON
    [PMM_LANG_RON] = {PMM_LANG_RON, empty_types, empty_types, empty_types, ron_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_ron, NULL},

    // PMM_LANG_THRIFT
    [PMM_LANG_THRIFT] = {PMM_LANG_THRIFT, thrift_func_types, thrift_class_types, thrift_field_types,
    ...
    // PMM_LANG_CAPNP
    [PMM_LANG_CAPNP] = {PMM_LANG_CAPNP, capnp_func_types, capnp_class_types, capnp_field_types,
    ...
    // PMM_LANG_PROPERTIES
    [PMM_LANG_PROPERTIES] = {PMM_LANG_PROPERTIES, empty_types, empty_types, empty_types,
    ...
    // PMM_LANG_SSHCONFIG
    [PMM_LANG_SSHCONFIG] = {PMM_LANG_SSHCONFIG, empty_types, empty_types, empty_types,
                            sshconfig_module_types, empty_types, empty_types, empty_types,
                            empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                            NULL, NULL, tree_sitter_ssh_config, NULL},

    // PMM_LANG_BIBTEX
    [PMM_LANG_BIBTEX] = {PMM_LANG_BIBTEX, empty_types, empty_types, empty_types,
                         bibtex_module_types, bibtex_call_types, empty_types, empty_types,
                         empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                         NULL, NULL, tree_sitter_bibtex, NULL},

    // PMM_LANG_STARLARK
    [PMM_LANG_STARLARK] = {PMM_LANG_STARLARK, starlark_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_BICEP
    [PMM_LANG_BICEP] = {PMM_LANG_BICEP, bicep_func_types, bicep_class_types, empty_types,
    ...
    // PMM_LANG_CSV
    [PMM_LANG_CSV] = {PMM_LANG_CSV, empty_types, empty_types, empty_types, csv_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_csv, NULL},

    // PMM_LANG_REQUIREMENTS
    [PMM_LANG_REQUIREMENTS] = {PMM_LANG_REQUIREMENTS, empty_types, empty_types, empty_types,
    ...
    // PMM_LANG_HLSL
    [PMM_LANG_HLSL] = {PMM_LANG_HLSL, hlsl_func_types, hlsl_class_types, empty_types,
    ...
    // PMM_LANG_VHDL
    [PMM_LANG_VHDL] = {PMM_LANG_VHDL, vhdl_func_types, vhdl_class_types, empty_types,
    ...
    [PMM_LANG_SYSTEMVERILOG] = {PMM_LANG_SYSTEMVERILOG, systemverilog_func_types,
    ...
    // PMM_LANG_DEVICETREE
    [PMM_LANG_DEVICETREE] = {PMM_LANG_DEVICETREE, empty_types, empty_types, empty_types,
    ...
    [PMM_LANG_LINKERSCRIPT] = {PMM_LANG_LINKERSCRIPT, empty_types, empty_types, empty_types,
                               linkerscript_module_types, linkerscript_call_types, empty_types,
                               empty_types, empty_types, empty_types, empty_types, empty_types,
                               NULL, empty_types, NULL, NULL, tree_sitter_linkerscript, NULL},

    // PMM_LANG_GN
    [PMM_LANG_GN] = {PMM_LANG_GN, empty_types, empty_types, empty_types, gn_module_types,
    ...
    // PMM_LANG_KCONFIG
    [PMM_LANG_KCONFIG] = {PMM_LANG_KCONFIG, empty_types, kconfig_class_types, empty_types,
    ...
    // PMM_LANG_BITBAKE
    [PMM_LANG_BITBAKE] = {PMM_LANG_BITBAKE, bitbake_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_SMALI
    [PMM_LANG_SMALI] = {PMM_LANG_SMALI, smali_func_types, smali_class_types, smali_field_types,
                        smali_module_types, empty_types, smali_import_types, empty_types,
                        empty_types, empty_types, empty_types, empty_types, NULL, empty_types, NULL,
                        NULL, tree_sitter_smali, NULL},

    // PMM_LANG_TABLEGEN
    [PMM_LANG_TABLEGEN] = {PMM_LANG_TABLEGEN, tablegen_func_types, tablegen_class_types,
                           empty_types, tablegen_module_types, empty_types, tablegen_import_types,
                           empty_types, empty_types, empty_types, empty_types, empty_types, NULL,
                           empty_types, NULL, NULL, tree_sitter_tablegen, NULL},

    // PMM_LANG_ISPC
    [PMM_LANG_ISPC] = {PMM_LANG_ISPC, ispc_func_types, ispc_class_types, empty_types,
    ...
    // PMM_LANG_CAIRO
    [PMM_LANG_CAIRO] = {PMM_LANG_CAIRO, cairo_func_types, cairo_class_types, empty_types,
    ...
    // PMM_LANG_MOVE
    [PMM_LANG_MOVE] = {PMM_LANG_MOVE, move_func_types, empty_types, empty_types, move_module_types,
    ...
    // PMM_LANG_SQUIRREL
    [PMM_LANG_SQUIRREL] = {PMM_LANG_SQUIRREL, squirrel_func_types, squirrel_class_types,
    ...
    // PMM_LANG_FUNC
    [PMM_LANG_FUNC] = {PMM_LANG_FUNC, func_func_types, empty_types, empty_types, func_module_types,
    ...
    // PMM_LANG_REGEX
    [PMM_LANG_REGEX] = {PMM_LANG_REGEX, empty_types, empty_types, empty_types, regex_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_regex,
                        NULL},

    // PMM_LANG_JSDOC
    [PMM_LANG_JSDOC] = {PMM_LANG_JSDOC, empty_types, empty_types, empty_types, jsdoc_module_types,
                        empty_types, empty_types, empty_types, empty_types, empty_types,
                        empty_types, empty_types, NULL, empty_types, NULL, NULL, tree_sitter_jsdoc,
                        NULL},

    // PMM_LANG_RST
    [PMM_LANG_RST] = {PMM_LANG_RST, empty_types, empty_types, empty_types, rst_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_rst, NULL},

    // PMM_LANG_BEANCOUNT
    [PMM_LANG_BEANCOUNT] = {PMM_LANG_BEANCOUNT, empty_types, empty_types, empty_types,
                            beancount_module_types, empty_types, beancount_import_types,
                            empty_types, empty_types, empty_types, empty_types, empty_types, NULL,
                            empty_types, NULL, NULL, tree_sitter_beancount, NULL},

    // PMM_LANG_MERMAID
    [PMM_LANG_MERMAID] = {PMM_LANG_MERMAID, empty_types, empty_types, empty_types,
                          mermaid_module_types, empty_types, empty_types, empty_types, empty_types,
                          empty_types, empty_types, empty_types, NULL, empty_types, NULL, NULL,
                          tree_sitter_mermaid, NULL},

    // PMM_LANG_PUPPET
    [PMM_LANG_PUPPET] = {PMM_LANG_PUPPET, puppet_func_types, puppet_class_types, empty_types,
    ...
    // PMM_LANG_SMITHY
    [PMM_LANG_SMITHY] = {PMM_LANG_SMITHY, smithy_func_types, smithy_class_types, smithy_field_types,
                         smithy_module_types, empty_types, smithy_import_types, empty_types,
                         empty_types, empty_types, empty_types, empty_types, NULL, empty_types,
                         NULL, NULL, tree_sitter_smithy, NULL},

    // PMM_LANG_WIT
    [PMM_LANG_WIT] = {PMM_LANG_WIT, wit_func_types, wit_class_types, wit_field_types,
                      wit_module_types, empty_types, wit_import_types, empty_types, empty_types,
                      empty_types, empty_types, empty_types, NULL, empty_types, NULL, NULL,
                      tree_sitter_wit, NULL},

    // PMM_LANG_TLAPLUS
    [PMM_LANG_TLAPLUS] = {PMM_LANG_TLAPLUS, tlaplus_func_types, empty_types, empty_types,
    ...
    // PMM_LANG_PKL
    [PMM_LANG_PKL] = {PMM_LANG_PKL, pkl_func_types, pkl_class_types, empty_types, pkl_module_types,
    ...
    // PMM_LANG_GOMOD
    [PMM_LANG_GOMOD] = {PMM_LANG_GOMOD, empty_types, empty_types, empty_types, gomod_module_types,
    ...
    // PMM_LANG_APEX
    [PMM_LANG_APEX] = {PMM_LANG_APEX, apex_func_types, apex_class_types, apex_field_types,
    ...
    // PMM_LANG_SOQL
    [PMM_LANG_SOQL] = {PMM_LANG_SOQL, empty_types, empty_types, empty_types, soql_module_types,
    ...
    // PMM_LANG_SOSL
    [PMM_LANG_SOSL] = {PMM_LANG_SOSL, empty_types, empty_types, empty_types, sosl_module_types,
    ...
    // PMM_LANG_KUSTOMIZE — reuses YAML grammar; semantic extraction via pmm_extract_k8s()
    [PMM_LANG_KUSTOMIZE] = {PMM_LANG_KUSTOMIZE, yaml_var_types, empty_types, empty_types,
                            yaml_module_types, empty_types, empty_types, empty_types, empty_types,
                            empty_types, empty_types, empty_types, NULL, empty_types, NULL, NULL,
                            tree_sitter_yaml, NULL},

    // PMM_LANG_K8S — reuses YAML grammar; semantic extraction via pmm_extract_k8s()
    [PMM_LANG_K8S] = {PMM_LANG_K8S, yaml_var_types, empty_types, empty_types, yaml_module_types,
                      empty_types, empty_types, empty_types, empty_types, empty_types, empty_types,
                      empty_types, NULL, empty_types, NULL, NULL, tree_sitter_yaml, NULL},

    // PMM_LANG_PINE — Pine Script (TradingView). kvarenzn/tree-sitter-pine (ISC).
    [PMM_LANG_PINE] = {PMM_LANG_PINE, pine_func_types, pine_class_types, empty_types,
    ...
    // PMM_LANG_MOJO
    [PMM_LANG_MOJO] = {PMM_LANG_MOJO, mojo_func_types, mojo_class_types, empty_types,
    ...
    // PMM_LANG_OBJECTSCRIPT_UDL — InterSystems ObjectScript class (.cls) UDL.
    // intersystems/tree-sitter-objectscript.
    [PMM_LANG_OBJECTSCRIPT_UDL] = {PMM_LANG_OBJECTSCRIPT_UDL, objectscript_udl_func_types,
    ...
    [PMM_LANG_OBJECTSCRIPT_ROUTINE] = {PMM_LANG_OBJECTSCRIPT_ROUTINE,
    ...
    // PMM_LANG_OBJECTSCRIPT_EXPORT — Studio Export XML. No grammar row: the
    // pipeline transcodes Export XML to UDL (iris_export_xml.c) and re-extracts
    // each class as PMM_LANG_OBJECTSCRIPT_UDL, so this language never reaches
    // pmm_lang_spec()/pmm_ts_language() directly. Left as a zero spec.

};

_Static_assert(sizeof(lang_specs) / sizeof(lang_specs[0]) == PMM_LANG_COUNT,
               "lang_specs array size must match PMM_LANG_COUNT");

const CBMLangSpec *pmm_lang_spec(CBMLanguage lang) {
...
const TSLanguage *pmm_ts_language(CBMLanguage lang) {
    const CBMLangSpec *spec = pmm_lang_spec(lang);
